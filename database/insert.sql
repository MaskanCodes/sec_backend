INSERT INTO sec_countries (country_id, country_name) VALUES
(1, 'United States'),
(2, 'Canada'),
(3, 'Mexico'),
(4, 'France'),
...
INSERT INTO sec_states (country_id, state_name,country_code) VALUES
(7, 'Andaman & Nicobar [AN]','+91'),
(7, 'Andhra Pradesh [AP]','+91'),
(7, 'Arunachal Pradesh [AR]','+91'),
(7, 'Assam [AS]','+91'),
(7, 'Bihar [BH]','+91'),
(7, 'Chandigarh [CH]','+91'),
(7, 'Chhattisgarh [CG]','+91'),
(7, 'Dadra & Nagar Haveli [DN]','+91'),
(7, 'Daman & Diu [DD]','+91'),
(7, 'Delhi [DL]','+91'),
(7, 'Goa [GO]','+91'),
(7, 'Gujarat [GU]','+91'),
(7, 'Haryana [HR]','+91'),
(7, 'Himachal Pradesh [HP]','+91'),
(7, 'Jammu & Kashmir [JK]','+91'),
(7, 'Jharkhand [JH]','+91'),
(7, 'Karnataka [KR]','+91'),
(7, 'Kerala [KL]','+91'),
(7, 'Lakshadweep [LD]','+91'),
(7, 'Madhya Pradesh [MP]','+91'),
(7, 'Maharashtra [MH]','+91'),
(7, 'Manipur [MN]','+91'),
(7, 'Meghalaya [ML]','+91'),
(7, 'Mizoram [MM]','+91'),
...
(7, 'Tamil Nadu [TN]','+91'),
(7, 'Tripura [TR]','+91'),
(7, 'Uttar Pradesh [UP]','+91'),
(7, 'Uttaranchal [UT]','+91'),
(7, 'West Bengal [WB]','+91');

-- Andaman & Nicobar
INSERT INTO sec_cities (city_name,city_code,state_id) VALUES
('Alipur', '101','1'),
...
INSERT INTO sec_roles (role_name) VALUES
('SuperAdmin'),
('Admin'),
('Doctor'),
('HCF'),
