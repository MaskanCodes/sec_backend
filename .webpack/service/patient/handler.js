...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   _createAppointment: () => (/* binding */ _createAppointment),
/* harmony export */   _updatePateintProfile: () => (/* binding */ _updatePateintProfile)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/defineProperty */ "@babel/runtime/helpers/defineProperty");
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__);
...
const _updatePateintProfile = async data => {
...
const _createAppointment = async userData => {
  // const records = { ...data };
  ...
  const user = await (0,_database_helper__WEBPACK_IMPORTED_MODULE_1__.createRecord)(_database_tables__WEBPACK_IMPORTED_MODULE_2__.tableNames.SEC_APPOINTMENTS, [newUser], true, "appointment_id");
  return (0,_configs_utility__WEBPACK_IMPORTED_MODULE_3__.createSuccessResponse)("Appointment Booked ", 202);
...
/* harmony export */   getAppointment: () => (/* binding */ getAppointment),
/* harmony export */   getDashboardDoctordetails: () => (/* binding */ getDashboardDoctordetails),
/* harmony export */   getDashboardDoctordetailsbyId: () => (/* binding */ getDashboardDoctordetailsbyId),
/* harmony export */   getDashboardHcfdetails: () => (/* binding */ getDashboardHcfdetails),
/* harmony export */   getDashboardHcfdetailsbyId: () => (/* binding */ getDashboardHcfdetailsbyId),
/* harmony export */   getPatientPlan: () => (/* binding */ getPatientPlan),
/* harmony export */   getPatientprofile: () => (/* binding */ getPatientprofile),
/* harmony export */   getTransaction: () => (/* binding */ getTransaction),
/* harmony export */   getappointmentHistory: () => (/* binding */ getappointmentHistory),
/* harmony export */   getpatientActivity: () => (/* binding */ getpatientActivity),
/* harmony export */   getpatientAppbystatusid: () => (/* binding */ getpatientAppbystatusid),
/* harmony export */   getpatientNotification: () => (/* binding */ getpatientNotification)
/* harmony export */ });
...
/* harmony import */ var _helpers_models_user_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../helpers/models/user-model */ "./helpers/models/user-model.js");
/* harmony import */ var _user_adapter__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./user-adapter */ "./patient/user-adapter.js");
...
const getPatientprofile = async (event, context, callback) => {
  try {
    const patientprofile = await (0,_database_helper__WEBPACK_IMPORTED_MODULE_1__.getAllRecords)(_database_tables__WEBPACK_IMPORTED_MODULE_0__.tableNames.SEC_USERS);
...
const createAppointment = async event => {
  try {
    const userData = (0,_configs_utility__WEBPACK_IMPORTED_MODULE_2__.parseEventBody)(event.body);
    ...
    const user = await (0,_user_adapter__WEBPACK_IMPORTED_MODULE_4__._createAppointment)(userData);
    if (user) {
      return (0,_configs_utility__WEBPACK_IMPORTED_MODULE_2__.createSuccessResponse)({
        response: user
      }, 200);
...
const getAppointment = async (event, context, callback) => {
  try {
    const patientAppointment = await (0,_database_helper__WEBPACK_IMPORTED_MODULE_1__.getAllRecords)(_database_tables__WEBPACK_IMPORTED_MODULE_0__.tableNames.SEC_APPOINTMENTS);
    return (0,_configs_utility__WEBPACK_IMPORTED_MODULE_2__.createSuccessResponse)({
      response: patientAppointment
    }, 200);
  } catch (err) {
...
const getDashboardDoctordetails = async (event, context, callback) => {
  try {
    const doctordetails = await (0,_database_helper__WEBPACK_IMPORTED_MODULE_1__.dashboarddocdetailsQuery)(_database_tables__WEBPACK_IMPORTED_MODULE_0__.tableNames.SEC_USERS, _database_tables__WEBPACK_IMPORTED_MODULE_0__.tableNames.SEC_DOCTORS_DETAILS, _database_tables__WEBPACK_IMPORTED_MODULE_0__.tableNames.SEC_DEPARTMENTS, "suid", "doctor_id", "speciality_id", "department_id");
    return (0,_configs_utility__WEBPACK_IMPORTED_MODULE_2__.createSuccessResponse)({
...
const getDashboardDoctordetailsbyId = async (event, context, callback) => {
  try {
    const doc_id = event.pathParameters.id;
    const doctordetails = await (0,_database_helper__WEBPACK_IMPORTED_MODULE_1__.dashboarddocdetailsQueryId)(_database_tables__WEBPACK_IMPORTED_MODULE_0__.tableNames.SEC_USERS, _database_tables__WEBPACK_IMPORTED_MODULE_0__.tableNames.SEC_DOCTORS_DETAILS, _database_tables__WEBPACK_IMPORTED_MODULE_0__.tableNames.SEC_DEPARTMENTS, "suid", "doctor_id", "speciality_id", "department_id", doc_id);
    return (0,_configs_utility__WEBPACK_IMPORTED_MODULE_2__.createSuccessResponse)({
      response: doctordetails
    }, 200);
  } catch (err) {
...
const getDashboardHcfdetails = async (event, context, callback) => {
  try {
    const hcfdetails = await (0,_database_helper__WEBPACK_IMPORTED_MODULE_1__.dashboardhcfdetailsQuery)(_database_tables__WEBPACK_IMPORTED_MODULE_0__.tableNames.SEC_USERS, _database_tables__WEBPACK_IMPORTED_MODULE_0__.tableNames.SEC_HCF_DETAILS, "suid", "hcf_id");
    return (0,_configs_utility__WEBPACK_IMPORTED_MODULE_2__.createSuccessResponse)({
      response: hcfdetails
    }, 200);
  } catch (err) {
...
const getDashboardHcfdetailsbyId = async (event, context, callback) => {
  try {
    const hcf_id = event.pathParameters.id;
    const hcfdetails = await (0,_database_helper__WEBPACK_IMPORTED_MODULE_1__.dashboardhcfdetailsQueryId)(_database_tables__WEBPACK_IMPORTED_MODULE_0__.tableNames.SEC_USERS, _database_tables__WEBPACK_IMPORTED_MODULE_0__.tableNames.SEC_HCF_DETAILS, "suid", "hcf_id", hcf_id);
    return (0,_configs_utility__WEBPACK_IMPORTED_MODULE_2__.createSuccessResponse)({
      response: hcfdetails
    }, 200);
  } catch (err) {
...
const getpatientActivity = async (event, context, callback) => {
  try {
    const app_id = event.pathParameters.id;
    const patientActivity = await (0,_database_helper__WEBPACK_IMPORTED_MODULE_1__.patientActivityQuery)(_database_tables__WEBPACK_IMPORTED_MODULE_0__.tableNames.SEC_APPOINTMENTS, app_id);
    return (0,_configs_utility__WEBPACK_IMPORTED_MODULE_2__.createSuccessResponse)({
      response: patientActivity
    }, 200);
  } catch (err) {
...
const getpatientNotification = async (event, context, callback) => {
  try {
    const app_id = event.pathParameters.id;
    const patientNotification = await (0,_database_helper__WEBPACK_IMPORTED_MODULE_1__.patientNotificationQuery)(_database_tables__WEBPACK_IMPORTED_MODULE_0__.tableNames.SEC_APPOINTMENTS, app_id);
    return (0,_configs_utility__WEBPACK_IMPORTED_MODULE_2__.createSuccessResponse)({
      response: patientNotification
    }, 200);
  } catch (err) {
...
const getpatientAppbystatusid = async (event, context, callback) => {
  try {
    const app_id = event.pathParameters.id;
    const app_status = event.pathParameters.status;
    const patientappointmentbystatus = await (0,_database_helper__WEBPACK_IMPORTED_MODULE_1__.patientappQuerybystatusid)(_database_tables__WEBPACK_IMPORTED_MODULE_0__.tableNames.SEC_APPOINTMENTS, app_status, app_id);
    console.log(patientappointmentbystatus);
    return (0,_configs_utility__WEBPACK_IMPORTED_MODULE_2__.createSuccessResponse)({
      response: patientappointmentbystatus
    }, 200);
  } catch (err) {
...
const getappointmentHistory = async (event, context, callback) => {
  try {
    const app_id = event.pathParameters.id;
    const patientAppointmentHistory = await (0,_database_helper__WEBPACK_IMPORTED_MODULE_1__.appointmentHistoryQuery)(_database_tables__WEBPACK_IMPORTED_MODULE_0__.tableNames.SEC_APPOINTMENTS, app_id);
    return (0,_configs_utility__WEBPACK_IMPORTED_MODULE_2__.createSuccessResponse)({
      response: patientAppointmentHistory
    }, 200);
  } catch (err) {
...
const getTransaction = async (event, context, callback) => {
  try {
    const user_id = event.pathParameters.id;
    const patientTransaction = await (0,_database_helper__WEBPACK_IMPORTED_MODULE_1__.patienttransactionQuery)(_database_tables__WEBPACK_IMPORTED_MODULE_0__.tableNames.SEC_TRANSACTIONS, user_id);
    return (0,_configs_utility__WEBPACK_IMPORTED_MODULE_2__.createSuccessResponse)({
      response: patientTransaction
    }, 200);
  } catch (err) {
...
const getPatientPlan = async (event, context, callback) => {
  try {
    const pat_id = event.pathParameters.id;
    const patientPlan = await (0,_database_helper__WEBPACK_IMPORTED_MODULE_1__.patientPlanQuery)(_database_tables__WEBPACK_IMPORTED_MODULE_0__.tableNames.SEC_PATIENT_PLANS, pat_id);
    return (0,_configs_utility__WEBPACK_IMPORTED_MODULE_2__.createSuccessResponse)({
      response: patientPlan
    }, 200);
  } catch (err) {
    console.log("Error in Transaction Query   handler", err, err.statusCode);
    return (0,_configs_utility__WEBPACK_IMPORTED_MODULE_2__.createErrorResponse)({
